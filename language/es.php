<?php
	...
	$parrafoUno='Web Progress es un equipo de venezolanos profesionales con amplia experiencia en desarrollo y diseño de páginas web, posicionamiento web, asesoramiento, aplicaciones móviles y negocios en Internet. que desde el 2009 se ha enfocado en integrar a las Pequeñas y Medianas Empresas en el mundo web.';
	$quéHacemos='Que Hacemos';
	$parrafoDos='Llevamos adelante tareas de Investigación & Desarrollo para estar a la vanguardia de las nuevas tecnologías. Invertimos constantemente en proyectos propios que ponen a prueba nuestro potencial de desarrollo, no solo en el campo de la tecnología, sino también en el de los negocios.';
